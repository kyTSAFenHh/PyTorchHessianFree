...
clone https://github.com/kyTSAFenHh/PyTorchHessianFree.git`. Then, navigate to the
...
- **Computing parameter updates:** Our Hessian-free optimizer offers two methods
  ...
  can be found
  [here](https://github.com/kyTSAFenHh/PyTorchHessianFree/blob/740bd80346873a75f904bbba15f0737403a3d511/examples/run_small_nn_acc.py).
